...
from html_renderer import render_card_document
from model_card_data import load_model_card_data, with_assets_dir
from model_card_document import SUPPORTED_TEMPLATES, SUPPORTED_THEMES, build_card_document
...
def build_model_card(
    ...
    if output_path is None:
        output_path = os.path.join(script_dir, "Model_Card.html")
